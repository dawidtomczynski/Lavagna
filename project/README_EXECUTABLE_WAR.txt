...
java -Ddatasource.dialect=MYSQL -Ddatasource.url=jdbc:mysql://mysqldb:3306/lavagna?useSSL=false -Ddatasource.username=test6 -Ddatasource.password=test -Dspring.profile.active=dev --port 8081 -jar lavagna-jetty-console.war
